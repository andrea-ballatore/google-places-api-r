---
title: "Google Place API: Extract search results"
output:
  html_document:
    self_contained: no
...
# Step 1: Extract POIs from Json

Extract all results from JSON files in ../tmp/ folder and save them in `../tmp/google_places_sdf.rds`.
...
# Step 2: Process POIs for dataset

This has to be adapted to particular geometry file.
